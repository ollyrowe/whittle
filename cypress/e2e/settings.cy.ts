describe("Settings", () => {
  it("displays correct default settings", () => {
    ...
    cy.getByTestID("restricted-mode-toggle")
      .find("input")
  ...
  it("persists the user's settings", () => {
    ...
    // Toggle each setting
    cy.getByTestID("restricted-mode-toggle").find("input").click();
    ...
    cy.getByTestID("restricted-mode-toggle").find("input").should("be.checked");
    cy.getByTestID("dark-theme-toggle")
      .find("input")
